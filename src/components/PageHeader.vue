    ...
    <header class="navbar">
        <div class="navbar-wrapper">
            <div class="header-container">
                ...
                <div class="content">
                    <div id="docsearch" class="algolia-search-box search" v-show="false"><button type="button"
                    ...
                    <div class="theme-toggler-content theme-toggler">
                        <button class="switch" role="switch" aria-label="切换暗色主题" aria-checked="false" v-on:click="toggleDarkMode">
